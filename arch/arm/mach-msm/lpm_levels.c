...
static struct of_device_id __initdata cpu_modes_mtch_tbl[] = {
...
static struct of_device_id __initdata system_modes_mtch_tbl[] = {
...
static struct of_device_id __initdata lpm_levels_match_table[] = {
